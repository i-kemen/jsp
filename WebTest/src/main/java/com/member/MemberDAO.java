...
public class MemberDAO implements MemberDAOInterface {
    ...
    public List<MemberDTO> getWithdrawalRequests() {
        ...
        try {
            conn = ds.getConnection();
            String query = "SELECT * FROM MEMBER WHERE MEMBERSTATUS = '탈퇴요청'";
            pstmt = conn.prepareStatement(query);
            rs = pstmt.executeQuery();
    ...
    @Override
    public List<MemberDTO> searchMembers(String columnName, String keyword) {
        ...
        try {
            conn = ds.getConnection();
            String query = "SELECT * FROM MEMBER WHERE " + columnName + " LIKE ?";
            pstmt = conn.prepareStatement(query);
