 ...
 * Generated at: 2023-06-27 04:35:21 UTC
...
public final class modify_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String id = (String) session.getAttribute("id"); 
      ...
      out.write("        ");
      out.write("\r\n");
      out.write("        <form action=\"ModifyOk\" method=\"post\" onsubmit=\"return validateForm()\">\r\n");
      ...
      out.print( password );
      out.write("\" required>\r\n");
      out.write("            <div class=\"error-message\" id=\"password-error\"></div><br>\r\n");
      out.write("            <label for=\"phone\">전화번호:</label>\r\n");
      out.write("            <input type=\"text\" id=\"phone\" name=\"phone\" value=\"");
      out.print( phone );
      out.write("\" required>\r\n");
      out.write("            <div class=\"error-message\" id=\"phone-error\"></div><br>\r\n");
      ...
      out.write("            const passwordErrorMessage = document.getElementById('password-error');\r\n");
      out.write("            const phoneInput = document.getElementById('phone');\r\n");
      out.write("            const phoneErrorMessage = document.getElementById('phone-error');\r\n");
      out.write("\r\n");
      out.write("            const password = passwordInput.value;\r\n");
      out.write("            const phone = phoneInput.value;\r\n");
      out.write("\r\n");
      out.write("            passwordErrorMessage.innerHTML = '';\r\n");
      out.write("            phoneErrorMessage.innerHTML = '';\r\n");
      out.write("\r\n");
      out.write("            if (password.length < 4 || !hasLetterAndDigit(password)) {\r\n");
      out.write("                passwordErrorMessage.innerHTML = '비밀번호는 영문과 숫자를 포함한 4글자 이상이어야 합니다.';\r\n");
      out.write("                return false;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            if (!isValidPhone(phone)) {\r\n");
      out.write("                phoneErrorMessage.innerHTML = '전화번호는 010-0000-0000 형식이어야 합니다.';\r\n");
      out.write("                return false;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function hasLetterAndDigit(password) {\r\n");
      out.write("            return /[a-zA-Z]/.test(password) && /\\d/.test(password);\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        function isValidPhone(phone) {\r\n");
      out.write("            const phoneRegex = /^010-[0-9]{4}-[0-9]{4}$/;\r\n");
